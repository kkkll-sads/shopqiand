...
const OrderDetail: React.FC<OrderDetailProps> = ({ orderId, onBack, onNavigate }) => {
    ...
    const isMixedOrder = order.pay_type === 'mixed';
                            ...
                            <div className="flex-1 min-w-0 flex flex-col justify-between">
                                ...
                                <div className="flex items-end justify-between">
                                    <div className="flex items-baseline gap-1">
                                        {isMixedOrder && orderPayMoney > 0 && orderPayScore > 0 ? (() => {
                                            ...
                                            <>
                                                ...
                                                {isScoreOrder && (
                                                    <span className="text-sm text-orange-500 font-medium">消费金</span>
                                                )}
                                            </>
                                        )}
                                    </div>
                        ...
                        {order.pay_type_text && (
                            <div className="flex justify-between items-center py-2 border-t border-gray-50 pt-4">
                                ...
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <span className="text-sm text-gray-900 font-medium">{order.pay_type === 'mixed' ? '组合支付' : order.pay_type_text}</span>
                                </div>
                            </div>
                        )}
