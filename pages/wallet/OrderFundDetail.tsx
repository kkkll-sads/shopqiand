...
import { ArrowLeft, FileText, Receipt, ShoppingCart, CreditCard } from 'lucide-react';
...
interface OrderFundDetailProps {
  onBack: () => void;
}

const OrderFundDetail: React.FC<OrderFundDetailProps> = ({ onBack }) => {
  ...
  return (
    <PageContainer title="订单资金详情" onBack={onBack}>
      {/* 加载状态 */}
