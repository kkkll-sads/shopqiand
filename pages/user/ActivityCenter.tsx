...
const ActivityCenter: React.FC<ActivityCenterProps> = ({ onBack, onNavigate }) => {
    ...
    const handleAction = (item: ActivityItem) => {
        ...
        switch (item.key) {
            case 'first_trade':
                onNavigate({ name: 'market' }); // 或 trading-zone
                break;
            case 'invite':
                onNavigate({ name: 'my-friends' });
                break;
            case 'recharge':
                onNavigate({ name: 'balance-recharge' });
                break;
            case 'questionnaire':
                onNavigate({ name: 'user-survey' });
                break;
            case 'real_name':
                onNavigate({ name: 'real-name-auth' });
                break;
            default:
    ...
    return (
        <PageContainer title="活动中心" onBack={onBack}>
