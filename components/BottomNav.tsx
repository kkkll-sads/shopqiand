...
const ShopIcon = ({ active }: { active: boolean }) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill={active ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth={active ? 0 : 1.5}>
    ...
    <path d="M3 6h18" stroke="currentColor" strokeWidth="1.5" fill="none" />
    <path d="M16 10a4 4 0 01-8 0" stroke="currentColor" strokeWidth="1.5" fill="none" />
  </svg>
);
...
const ShieldIcon = ({ active }: { active: boolean }) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill={active ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth={active ? 0 : 1.5}>
    ...
    {!active && <path d="M9 12l2 2 4-4" stroke="currentColor" strokeWidth="1.5" fill="none" />}
  </svg>
);
...
const TvIcon = ({ active }: { active: boolean }) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill={active ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth={active ? 0 : 1.5}>
    ...
    <polyline points="17 2 12 7 7 2" fill="none" stroke="currentColor" strokeWidth="1.5" />
  </svg>
);
