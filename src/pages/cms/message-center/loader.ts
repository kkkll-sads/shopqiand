  ...
  try {
    ...
    pendingPayData?.list?.forEach((item: ShopOrderItem) => {
      ...
      messages.push({
        ...
        time: item.create_time_text || '',
        timestamp: normalizeUnixTimeToMillis(item.create_time),
        isRead: readIds.includes(id),
    ...
    pendingShipData?.list?.forEach((item: ShopOrderItem) => {
      ...
      messages.push({
        ...
        timestamp: normalizeUnixTimeToMillis(item.pay_time),
        isRead: readIds.includes(id),
    ...
    pendingConfirmData?.list?.forEach((item: ShopOrderItem) => {
      ...
      messages.push({
        ...
        timestamp: normalizeUnixTimeToMillis(item.ship_time),
        isRead: readIds.includes(id),
