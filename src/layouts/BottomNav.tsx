        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center justify-center py-0.5 min-w-[56px] transition-all duration-150 ${
                isActive ? 'text-red-600' : 'text-gray-600'
              } ${isPressed ? 'scale-90 opacity-80' : 'scale-100 opacity-100'}`}
            >
              <div className={`transition-transform duration-150 ${isPressed ? 'scale-90' : 'scale-100'}`}>
