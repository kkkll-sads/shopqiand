...
| order_no | string | 成交订单号 |
| flow_no | string | 卖家收益流水号 |
| sold_time_text | string | 成交时间 |
...
```json
{
    ...
    "data": {
        ...
        "remaining_days": 0,
        "can_force_delivery": false,
        "order_no": "BB202601231530001234560001",
        "flow_no": "SJS20260123153000987654",
        "sold_time_text": "2026-01-23 15:00:00"
    }
}
```
